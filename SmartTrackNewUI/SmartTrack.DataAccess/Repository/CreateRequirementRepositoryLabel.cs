...
namespace SmartTrack.DataAccess.Repository
{
    ...
    public class CreateRequirementRepositoryLabel
    {
        public CreateRequirementModelLabel GetCreateRequirementData(DataRow REQ_Data)
        {
            CreateRequirementModelLabel createRequirementModelLabel = new CreateRequirementModelLabel();
            createRequirementModelLabel.strBrowserName = REQ_Data["P1"].ToString().Trim();
            createRequirementModelLabel.strClientName = REQ_Data["P3"].ToString().Trim();
            createRequirementModelLabel.strMainMenuLink = REQ_Data["P4"].ToString().Trim();
            createRequirementModelLabel.strSubMenuLink = REQ_Data["P5"].ToString().Trim();
            createRequirementModelLabel.strSelectRequisitionType = REQ_Data["P6"].ToString().Trim();
            createRequirementModelLabel.strNewRequisition = REQ_Data["P7"].ToString().Trim();

            createRequirementModelLabel.str_TypeHead_CreatedUserID = REQ_Data["P8"].ToString().Trim();


            //    createRequirementModelLabel.str_Select_MatrixNumber = REQ_Data["P8"].ToString().Trim();
            createRequirementModelLabel.strSelectBusinessArea = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_GLBusinessUnit_GLId = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_Select_ServiceMethod = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_Select_deptNumber = REQ_Data["P11"].ToString().Trim();
            createRequirementModelLabel.str_TypeHead_deptNumber = REQ_Data["P12"].ToString().Trim();

            createRequirementModelLabel.strTypeHeadCostCenter = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.strSelectGeneralLedgerAccount = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.strSelectReasonforHire = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.strTxtNumberofResources = REQ_Data["P16"].ToString().Trim();

            createRequirementModelLabel.str_Select_MaterialGroup = REQ_Data["P17"].ToString().Trim();
            createRequirementModelLabel.strEngagingManager = REQ_Data["P18"].ToString().Trim();

            createRequirementModelLabel.strAltEngagingManager = REQ_Data["P19"].ToString().Trim();

            createRequirementModelLabel.strDateAssignmentStart = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.strDateAssignmentEnd = REQ_Data["P21"].ToString().Trim();
            createRequirementModelLabel.strDateAssignmentEnd_Month = REQ_Data["P22"].ToString().Trim();
            createRequirementModelLabel.strTxtWorkLocation = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.strSelectWorkLocationAddress = REQ_Data["P24"].ToString().Trim();

            //Tufts client filed

            createRequirementModelLabel.strjustification = REQ_Data["P28"].ToString().Trim();


            createRequirementModelLabel.str_GlAccount = REQ_Data["P29"].ToString().Trim();

            createRequirementModelLabel.str_type_siteLocationID = REQ_Data["P25"].ToString().Trim();
            createRequirementModelLabel.strSelectWorkweek = REQ_Data["P26"].ToString().Trim();
            createRequirementModelLabel.strSelectCostCenter = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.strtxtLegalEntity = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_TypeHead_programId = REQ_Data["P13"].ToString().Trim();
            //  createRequirementModelLabel.strEngagingManager_LastName = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_TypeHead_ProjectName = REQ_Data["P15"].ToString().Trim();

            createRequirementModelLabel.str_RadioBtn_ChargingMethod = REQ_Data["P17"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_AccountAssignment = REQ_Data["P17"].ToString().Trim();
            createRequirementModelLabel.str_Select_KCPLComplianceAccessNeeded = REQ_Data["P17"].ToString().Trim();
            createRequirementModelLabel.str_Txt_AccountAssignment = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.stSelectrUnionName = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_Txt_FundingSource = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_Select_ACADLevel = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_Txt_EAA_Approver = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_Select_HeadcountApproved = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_Txt_ServiceDept = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_Txt_ProfitCenter = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_Txt_CostCenterId = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_TypeHead_CostCenterId = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_Select_KCPLReasonforEngagement = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_Txt_ProductDept = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_Select_Program = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_Select_EngagementType = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.strSelectPriority = REQ_Data["P21"].ToString().Trim();

            createRequirementModelLabel.strSelectWorkLocation = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.str_Select_SecurityClearance = REQ_Data["P24"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_CanStartWithoutClearance = REQ_Data["P25"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_SpecificIndividualRequired = REQ_Data["P25"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_BadgeAccess = REQ_Data["P25"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_Radio1 = REQ_Data["P25"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_Radio2 = REQ_Data["P26"].ToString().Trim();
            createRequirementModelLabel.str_Txt_EPPICProject = REQ_Data["P26"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_Radio3 = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_Workweek = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_Radio4 = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_Btn_SpecificIndividualRequired = REQ_Data["P26"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_InterimClearanceSufficient = REQ_Data["P26"].ToString().Trim();
            createRequirementModelLabel.str_Txt_PrimeContractNumber = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_select_spendLevelId = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_Button_SecurityClearanceDetailsMSGActionButton = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_select_EPPICRegion = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.strtrainingStartDate = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_Button_MsgwindowActionButton = REQ_Data["P29"].ToString().Trim();
            createRequirementModelLabel.str_Select_EPPICResourcePool = REQ_Data["P29"].ToString().Trim();
            createRequirementModelLabel.strTxtJustificationtoHire = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_Select_EPPICResourcePool = REQ_Data["P29"].ToString().Trim();


            createRequirementModelLabel.strSelectOrganization = REQ_Data["P34"].ToString().Trim();
            createRequirementModelLabel.str_Txt_PlantNumber = REQ_Data["P34"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_computerAccess = REQ_Data["P34"].ToString().Trim();

            createRequirementModelLabel.str_Txt_MailStation = REQ_Data["P36"].ToString().Trim();
            createRequirementModelLabel.str_Radio_NetworkAccessNeeded = REQ_Data["P36"].ToString().Trim();
            createRequirementModelLabel.str_Txt_NetworkAccessRole = REQ_Data["P37"].ToString().Trim();
            createRequirementModelLabel.str_Radio_CaesarsEmailNeeded = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.btnOutLine_Action_Button = REQ_Data["P37"].ToString().Trim();
            createRequirementModelLabel.strSelectTypeofService = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.strSelectJobTitle = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.strTextAreaJobDescription = REQ_Data["P40"].ToString().Trim();
            createRequirementModelLabel.strtxtSkills_Mandatory = REQ_Data["P41"].ToString().Trim();
            createRequirementModelLabel.strtxtSkills_Desired = REQ_Data["P42"].ToString().Trim();
            createRequirementModelLabel.strtxtSkills_Name = REQ_Data["P43"].ToString().Trim();
            createRequirementModelLabel.strtxtSkills_Description = REQ_Data["P44"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnSkills_Level = REQ_Data["P45"].ToString().Trim();
            createRequirementModelLabel.strSelectSkills_Years = REQ_Data["P46"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_RegularUseofaCompanyVehicle = REQ_Data["P47"].ToString().Trim();
            createRequirementModelLabel.strtxtSpecialNeeds_Category = REQ_Data["P48"].ToString().Trim();
            createRequirementModelLabel.strtxtSpecialNeeds_Description = REQ_Data["P49"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnRecurring = REQ_Data["P50"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnFrequency = REQ_Data["P51"].ToString().Trim();
            createRequirementModelLabel.strSelect_Recurring_Frequency_MSG_Box = REQ_Data["P52"].ToString().Trim();
            createRequirementModelLabel.strButton_Recurring_Frequency_MSG_Box_Action_Button = REQ_Data["P53"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnInterviewRequired = REQ_Data["P54"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_CandidateMeeting = REQ_Data["P54"].ToString().Trim();

            createRequirementModelLabel.strRadiobtnTravelRequired = REQ_Data["P55"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_TravelandAncillaryExpenses = REQ_Data["P55"].ToString().Trim();
            createRequirementModelLabel.strtxtTravelLocation = REQ_Data["P56"].ToString().Trim();
            createRequirementModelLabel.strTxt_expenseFixedAmount = REQ_Data["P56"].ToString().Trim();
            createRequirementModelLabel.strtxtTravelDescription = REQ_Data["P57"].ToString().Trim();
            createRequirementModelLabel.strTxt_ContractValueCalculation_rdtypeoption = REQ_Data["P58"].ToString().Trim();

            createRequirementModelLabel.strtxtPayRateMin = REQ_Data["P59"].ToString().Trim();
            createRequirementModelLabel.strtxtPayRateMax = REQ_Data["P60"].ToString().Trim();
            createRequirementModelLabel.strtxtBillRateMin = REQ_Data["P61"].ToString().Trim();
            createRequirementModelLabel.strtxtBillRateMax = REQ_Data["P62"].ToString().Trim();
            createRequirementModelLabel.strtxtEstimatedContractValue = REQ_Data["P63"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_KcplTotalEstimatedDollarValue = REQ_Data["P63"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnRateNegotiable = REQ_Data["P64"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnSubmit_resumes_with_higher_rates = REQ_Data["P65"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnOTAllowed = REQ_Data["P66"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_OT_Limitation = REQ_Data["P67"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_KcplMileage_Reimbursement = REQ_Data["P71"].ToString().Trim();
            createRequirementModelLabel.strTxt_otHoursLimit = REQ_Data["P68"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_otPreTrue = REQ_Data["P69"].ToString().Trim();
            createRequirementModelLabel.strRadiobtnExempt_NonExempt = REQ_Data["P70"].ToString().Trim();
            createRequirementModelLabel.strselectShift = REQ_Data["P71"].ToString().Trim();
            createRequirementModelLabel.strTxt_shiftDiffPercent = REQ_Data["P72"].ToString().Trim();

            createRequirementModelLabel.strtxtapprovedTotalHours = REQ_Data["P75"].ToString().Trim();
            createRequirementModelLabel.strselectcurrencyID = REQ_Data["P76"].ToString().Trim();

            createRequirementModelLabel.strbtnJobDesc_Action_Button = REQ_Data["P81"].ToString().Trim();
            createRequirementModelLabel.strChkbox_guidelineAccepted = REQ_Data["P82"].ToString().Trim();
            createRequirementModelLabel.strTxt_hasOTHours = REQ_Data["P82"].ToString().Trim();
            createRequirementModelLabel.strtxtEstWeeklyHours = REQ_Data["P83"].ToString().Trim();
            createRequirementModelLabel.strTxt_hasOTHours = REQ_Data["P74"].ToString().Trim();
            createRequirementModelLabel.strtxtEstWeeklyHours = REQ_Data["P75"].ToString().Trim();
            createRequirementModelLabel.strselectrateTypeID = REQ_Data["P77"].ToString().Trim();
            createRequirementModelLabel.str_Txt_UploadFilePath = REQ_Data["P78"].ToString().Trim();
            createRequirementModelLabel.strRadiobtn_Workflow = REQ_Data["P83"].ToString().Trim();
            createRequirementModelLabel.strbtnWorkflow_Action_Button = REQ_Data["P84"].ToString().Trim();
            createRequirementModelLabel.strbtnAppQuestion_Action_Button = REQ_Data["P85"].ToString().Trim();
            createRequirementModelLabel.strbtnReviewSubmit_Action_Button = REQ_Data["P86"].ToString().Trim();
            createRequirementModelLabel.str_RadioBtn_template1 = REQ_Data["P87"].ToString().Trim();
            // createRequirementModelLabel.str_RadioBtn_template1 = REQ_Data["P81"].ToString().Trim();
            createRequirementModelLabel.strtxtEstimatedExpenseAmount = REQ_Data["P79"].ToString().Trim();
            createRequirementModelLabel.str_Txt_txtReqNo = REQ_Data["P80"].ToString().Trim();
            createRequirementModelLabel.str_TypeHead_txtdeptNumber = REQ_Data["P81"].ToString().Trim();
            createRequirementModelLabel.str_txtstartDateFrom = REQ_Data["P82"].ToString().Trim();
            createRequirementModelLabel.str_txtHiringManager = REQ_Data["P84"].ToString().Trim();
            createRequirementModelLabel.str_Txt_txtSAElastName = REQ_Data["P85"].ToString().Trim();
            createRequirementModelLabel.str_txtJobTitle = REQ_Data["P86"].ToString().Trim();
            createRequirementModelLabel.str_Select_txtServiceType = REQ_Data["P87"].ToString().Trim();
            createRequirementModelLabel.str_Select_txtOrganization = REQ_Data["P88"].ToString().Trim();
            createRequirementModelLabel.str_Select_txtLocationType = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_Select_searchButton = REQ_Data["P91"].ToString().Trim();
            createRequirementModelLabel.str_btn_SelectRequisition = REQ_Data["P92"].ToString().Trim();

            //Add Section
            createRequirementModelLabel.str_Application_Section_Name = REQ_Data["P93"].ToString().Trim();
            createRequirementModelLabel.str_btn_Addsection_Section_Name2 = REQ_Data["P94"].ToString().Trim();
            createRequirementModelLabel.str_AddSection_SaveContinue_Btn = REQ_Data["P95"].ToString().Trim();
            createRequirementModelLabel.str_btn_Addsection_Saveandclose = REQ_Data["P96"].ToString().Trim();
            createRequirementModelLabel.str_btn_Addsection = REQ_Data["P97"].ToString().Trim();   // Click on Add Selection

            //Add Question
            //createRequirementModelLabel.str_btn_Addsection_Saveandcontinue = REQ_Data["P93"].ToString().Trim();          
            createRequirementModelLabel.str_btn_Addquestion = REQ_Data["P98"].ToString().Trim();   // Click on Add Question Button
            createRequirementModelLabel.str_select_questiontype = REQ_Data["P99"].ToString().Trim();   // SheetName
            createRequirementModelLabel.strTestCaseId = REQ_Data["TestCaseID"].ToString().Trim();
            createRequirementModelLabel.str_Questionselection = REQ_Data["P9"].ToString().Trim();

            //Create requirement Template scenarion
            createRequirementModelLabel.strbtnSaveasMytemplate_Action_Button = REQ_Data["P79"].ToString().Trim();
            createRequirementModelLabel.strtxttemplateName = REQ_Data["P81"].ToString().Trim();
            createRequirementModelLabel.strbtntemplatesubmit = REQ_Data["P82"].ToString().Trim();
            createRequirementModelLabel.strbtncancelpopupyes = REQ_Data["P83"].ToString().Trim();

            //  Create requirement Save as Draft scenario

            createRequirementModelLabel.str_btn_SaveasDraft = REQ_Data["P18"].ToString().Trim();

            //cp chem
            createRequirementModelLabel.str_T1_Typeahead_Requestor_CreatedUserID = REQ_Data["P8"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_OrganizationName_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_Organization_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_AccountCode_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_BusinessUnit_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_BusinessArea_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_Company_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_LabourCategory_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ServiceMethod_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_EngagementType_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_HRCostCenter_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_Program_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ACADlevel_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_GLAccount_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ContractorCatergory_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_GeneralLedgerAccount_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ObjectAccount_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_ExpenseAmount_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_APCostCenter_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_CostCenter_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_CostCenter_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_BusinessUnit_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ContractorCost_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_BusinessArea_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ReasontoHire_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ReasonForEngagement_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_ReasonforRequest_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_Txt_NumberofResources_noofresources = REQ_Data["P16"].ToString().Trim();
            createRequirementModelLabel.str_T1_Txt_NumberofPositions_noofresources = REQ_Data["P16"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_HiringManager_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Leader_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_EngagingManager_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_HiringLeader_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_AlternateHiringManager_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_AlternateHiringManager_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_FinancialPartner_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_FFDSupervisor_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Supervisor_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_AnticipatedStartDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_NeededDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_AssignmentStartDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_DesiredStartDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_StartDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_PlannedEndDate_enddate = REQ_Data["P21"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_AssignmentEndDate_enddate = REQ_Data["P21"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_EndDate_enddate = REQ_Data["P21"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Worklocation_workLocationID = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_Worklocation_workLocationID = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_PersonnelArea_workLocationID = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_WorkLocationAddress_workLocationAddress = REQ_Data["P24"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_PersonnelAreaAddress_workLocationAddress = REQ_Data["P24"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_WorkWeek_workScheduleID = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_JustificationtoHire_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_PatientNameandOtherDetails_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_RequestJustification_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_SystemAcess_directIndirect = REQ_Data["P33"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_AcessLocation_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_SiteLocation_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_BadgeAcess_laborClassCode = REQ_Data["P32"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_AccountUnitName_deptName = REQ_Data["P34"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_Priority_priority = REQ_Data["P35"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_Union_directIndirect = REQ_Data["P36"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_ChargingMethod_directIndirect = REQ_Data["P36"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_AccountingUnit_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Department_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_CompanyCode_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_UnitNumber_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Team_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_UnionName_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_HeadcountApproved_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_SCAPosition_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_BusinessUnit_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_ProjectWBSElement_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_text_ProjectCodeCFR_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_PONumber_poNumber = REQ_Data["P110"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_MailStation_matrixNumber = REQ_Data["P111"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_FundingSource_matrixNumber = REQ_Data["P111"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_ACAD_directIndirect = REQ_Data["P112"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_ComputerAccess_computerAccess = REQ_Data["P113"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_CIPAcess_ciplocation = REQ_Data["P114"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_LegalEntity_association = REQ_Data["P115"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_servicedept_ServDept = REQ_Data["P116"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_ProductDept_ProDept = REQ_Data["P117"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_SecurityClearance_securityClearanceLevelID = REQ_Data["P118"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_CanStartwithoutClearance_txtWithout = REQ_Data["P119"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_InterimClearanceSufficient_txtSufficient = REQ_Data["P120"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_PrimeContractNumber_txtContractNumber = REQ_Data["P121"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_SecurityClearanceDetailsMSGActionButton_Submit = REQ_Data["P122"].ToString().Trim();
            //   createRequirementModelLabel.str_T1_Typeahead_EngagingManager_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_unionPosition_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_GamingProcess_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ReasonforthisRequest_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_Justification_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_NetworkAcessNeeded_radio6 = REQ_Data["P124"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_NetwotkAcessRole_singleLine7 = REQ_Data["P125"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_CeasarsEmailNeeded_radio5 = REQ_Data["P126"].ToString().Trim();
            createRequirementModelLabel.str_T1_Radio_AccountAssignment_CostCenter_AccountAssignment1 = REQ_Data["P127"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_AccountAssignmentWBS_ProjectId = REQ_Data["P128"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_FunctionalArea_ProfitCenterId = REQ_Data["P129"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_Department_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_typehead_PurchaseOrderNumber_CostCenterId = REQ_Data["P30"].ToString().Trim();
            //job descripition 
            createRequirementModelLabel.str_T2_select_JobCategories_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_Select_TypeofService_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_PositionType_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_FunctionType_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_JobClassification_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_Select_JobCategory_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_Typeahead_JobTitle_txtJobTitle = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_JobDescription_jobDescription = REQ_Data["P40"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_SkillMandatory_skillDescMandatory = REQ_Data["P41"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_SkillDesired_skillDescDesired = REQ_Data["P42"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_IdealCandidate_skillDescDesired = REQ_Data["P42"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_SkillMatrix_skillName = REQ_Data["P43"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_SkillDescription_skillDescription = REQ_Data["P44"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobtn_Level_skillLevelID = REQ_Data["P45"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_year_skillYearsExpID = REQ_Data["P46"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_Catgerory_specialNeedCategoryID = REQ_Data["P48"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Description_specialNeedDescription = REQ_Data["P49"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_mandatoryPrestartFalse = REQ_Data["P50"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_recurringScheduleTrue = REQ_Data["P51"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_Recurring_recurringScheduleFalse = REQ_Data["P51"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_Recurringfrequency_ddlFrequency = REQ_Data["P52"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_InterviewRequired_interviewRequired = REQ_Data["P54"].ToString().Trim();
            createRequirementModelLabel.str_T2_radiobutton_TravelRequired_travel = REQ_Data["P55"].ToString().Trim();

            createRequirementModelLabel.str_T2_Radiobutton_Exempt_exemptTrue = REQ_Data["P70"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_Shift_shiftID = REQ_Data["P71"].ToString().Trim();
            createRequirementModelLabel.str_T2_Amount_shiftDiffPercent = REQ_Data["P72"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_OtAllowed_OtAllowed = REQ_Data["P66"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_OtLimitation_OtLimit = REQ_Data["P67"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_MaximumOvertimeHoursApprovedperweek_otHoursLimit = REQ_Data["P68"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_OtPerTrue_OtpreTrue = REQ_Data["P69"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_TravelandAncillaryExpensesyes_expenses = REQ_Data["P55"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_EstimatedExpenseAmountperResource_expenseFixedAmount = REQ_Data["P56"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_TravelRequired_travel = REQ_Data["P55"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_TravelLocation_travelLocation = REQ_Data["P56"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_TravelDescription_travelDescription = REQ_Data["P57"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_AnticipatedaverageOTperweek_hasOTHours = REQ_Data["P74"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Estimatedofweeklyhours_EstWeeklyHours = REQ_Data["P74"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_EstimatedTotalofHours_approvedTotalHours = REQ_Data["P75"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_Currency_currencyID = REQ_Data["P76"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_ratetype_rateTypeID = REQ_Data["P77"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_PayRateLow_payRateLow = REQ_Data["P59"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_PayRateHigh_payRateHigh = REQ_Data["P60"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Billratelow_billRateLow = REQ_Data["P61"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_BillrateHigh_billRateHigh = REQ_Data["P62"].ToString().Trim();
            createRequirementModelLabel.str_t2_txt_EstimatedContractValue_estContractValue = REQ_Data["P63"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_totalContractValue_estContractValue = REQ_Data["P63"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_RateNegotiable_rateNego = REQ_Data["P64"].ToString().Trim();
            createRequirementModelLabel.str_T3_guidelines_guidelineAccepted = REQ_Data["P82"].ToString().Trim();

            createRequirementModelLabel.str_T2_Typeahead_JobCategory_txtJobTitle = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_JobDescription_jobDescription = REQ_Data["P40"].ToString().Trim();

            #region rakesh
            createRequirementModelLabel.str_T1_typehead_LocationCode_CostCenterId = REQ_Data["P134"].ToString().Trim();
            createRequirementModelLabel.str_T1_Txt_LocationName_CostCenterName = REQ_Data["P135"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_ShiftStart_ProfitCenterId = REQ_Data["P136"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_ShiftEnd_spendLevelId = REQ_Data["P137"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_Comments_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T2_Txt_WeeklySpend_WeeklySpendValue = REQ_Data["P143"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ReasonToEngage_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_DirectFill_laborClassCode = REQ_Data["P108"].ToString().Trim();
            #endregion
            createRequirementModelLabel.str_T1_Typeahead_Requestor_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_RCCode_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_AlternateRequestor_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_AccountCode_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_YPCompany_siteLocationID = REQ_Data["P31"].ToString().Trim();

            createRequirementModelLabel.str_T2_Typeahead_Title_txtJobTitle = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.str_T2_Typeahead_AssignmentDetail_jobDescription = REQ_Data["P40"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_HRReviewed_computerAccess = REQ_Data["P113"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Branch_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_programManager_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_Company_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_AccountUnit_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_text_MatrixNumber_matrixNumber = REQ_Data["P111"].ToString().Trim();
            createRequirementModelLabel.str_T1_typehead_MatrixManager_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_typeahead_FunctionalManager_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_Department_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_CoEReqType_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_POID_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_TypeofAssignment_workScheduleID = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_AdditionalWorkLocationDetails_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_LaborCategory_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_Isthisareplacementrequistion_directIndirectTrue = REQ_Data["P130"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_IsthisareplacementrequistionRequistion_association = REQ_Data["P131"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_IsOnCallRequired_shiftTrue = REQ_Data["P132"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_IsOnCallRequiredAmount_shiftDiffAmount = REQ_Data["P133"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_BillRateRange_billRateLow = REQ_Data["P61"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_BillRateRange_billRateHigh = REQ_Data["P62"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_AssignmentDescription_jobDescription = REQ_Data["P40"].ToString().Trim();
            createRequirementModelLabel.str_Typeahead_DelegateofAuthority_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Radio_CostCenterOrProfitCenter_AccountAssignment1 = REQ_Data["P144"].ToString().Trim();
            createRequirementModelLabel.str_T1_Radio_ProjectOrWBSElement_AccountAssignment3 = REQ_Data["P144"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_PurchasingGroup_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_txt_Requisitioner_CreatedUserID = REQ_Data["P145"].ToString().Trim();
            createRequirementModelLabel.str_select_MaterialGroup_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_select_PurchaseOrganization_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_Typeahead_PlantNumber_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typehead_ProfitCenter_ProfitCenterId = REQ_Data["P129"].ToString().Trim();
            createRequirementModelLabel.str_T1_typehead_EngagingManagerPM_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_datepicker_NeededDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_datepicker_EndDate_enddate = REQ_Data["P21"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_QualityAssurance_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_PlaceOfWork_siteLocationID = REQ_Data["P25"].ToString().Trim();
            createRequirementModelLabel.str_T1_TypeHead_CompanyCode_deptNumber = REQ_Data["P12"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_WorkLocation_workLocationID = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_IncumbentNameTermDate_JustificationtoHire = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_TypeHead_WorkLocationAddress_workLocationAddress = REQ_Data["P24"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_JustificationforOpening_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T2_TypeHead_JobTitle_txtJobTitle = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_Divison_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_COEBAT_ProfitCenterId = REQ_Data["P129"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_DeptProgramTaskOrder_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_PA_association = REQ_Data["P115"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_PAA_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_ManagerPeopleSoftNumber_ServDept = REQ_Data["P116"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_USCitizenshipRequired_laborClassCode = REQ_Data["P146"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_EAAApprover_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_Justificationforhire_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_LegalEntity_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_BusinessArea_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_NaturalAccount_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_LocalAnalysis_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Fiscal_matrixNumber = REQ_Data["P111"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Intercompany_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_BusinessUnit_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_EmergencyPosition_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_txt_AdditionalrequirementDetails_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_Isthisareplacementrequisition_directIndirect = REQ_Data["P149"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Requisition_association = REQ_Data["P150"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_Arethereunionizedworkersatthislocation_UnauthorizedWorker = REQ_Data["P151"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_CBAContract_CollectiveBargainingAgreementCode = REQ_Data["P152"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_Isthepositionexpectedtobelongerthan13weeks_interviewRequired = REQ_Data["P153"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Amount_shiftDiffAmount = REQ_Data["P155"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_Isthereashiftdifferential_shift = REQ_Data["P154"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Workinghours_shiftDiffPercent = REQ_Data["P156"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_IsTravelRequired_expenses = REQ_Data["P157"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_FundingSource_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_JobTitle_jobTitleID = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.str_T2_selectGLAccount_GLIdJD = REQ_Data["P147"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_ComputerSystemsAccess_ComputerSystemsAccess = REQ_Data["P113"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_ComplianceAccessNeeded_matrixNumber = REQ_Data["P113"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radio_RegularUseofaCompanyVehicle = REQ_Data["P11"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radio_ExemptNonExempt = REQ_Data["P11"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radio_MileageReimbursement = REQ_Data["P11"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ShiftEnd_spendLevelId = REQ_Data["P158"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ShiftStart_ProfitCenterId = REQ_Data["P136"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_GoodsReceiptApprover_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_BuyerName_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_OrganizationName_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_CourseName_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_SpendCategory_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Fund_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Purpose_ProfitCenterId = REQ_Data["P129"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_ProgramName_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_Txt_POdetailsRemoteCWWorklocationaddress_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_txt_TemplateName_templateName = REQ_Data["P194"].ToString().Trim();
            createRequirementModelLabel.str_btn_TemplateSubmit_Submit = REQ_Data["P195"].ToString().Trim();
            createRequirementModelLabel.str_btn_TemplateCancel_Cancel = REQ_Data["P196"].ToString().Trim();
            createRequirementModelLabel.str_btn_TemplateCancel_btnReviewCancel = REQ_Data["P197"].ToString().Trim();
            createRequirementModelLabel.str_T1_Radiobtn_CWCanWorkRemotely_directIndirect = REQ_Data["P159"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Division_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_Search_searchButton = REQ_Data["P198"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Divison_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_ReqType_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_SubDivision_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_Department_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Txt_Comments_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Department_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_AccountCode_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_SupervisorOrg_ProfitCenterId = REQ_Data["P129"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_FinanceEntity_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_BusinessStructure_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_TargetStartDate_neededStartDate = REQ_Data["P20"].ToString().Trim();
            createRequirementModelLabel.str_T1_Date_TargetEnddate_enddate = REQ_Data["P21"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_PrimaryLocation_workLocationID = REQ_Data["P23"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_PrimaryLocationAddress_workLocationAddress = REQ_Data["P24"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_ProductLine_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_DirectFill_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_WorkerSubType_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_Txt_Justification_JustificationtoHire = REQ_Data["P28"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_TimeType_workScheduleID = REQ_Data["P27"].ToString().Trim();
            createRequirementModelLabel.str_T2_Typeahead_JobPostingTitle_txtJobTitle = REQ_Data["P39"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_CandidateMeeting_inter = REQ_Data["P54"].ToString().Trim();
            createRequirementModelLabel.str_T2_Select_Workshift_shiftID = REQ_Data["P71"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Requestor_createdUserID = REQ_Data["P8"].ToString().Trim();

            createRequirementModelLabel.str_T1_select_CompanyNumber_deptNumber = REQ_Data["P11"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_CommodityCode_laborClassCode = REQ_Data["P142"].ToString().Trim();

            createRequirementModelLabel.str_T1_select_ReasonForHire_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_TypeHead_EPPICProject_ProjectId = REQ_Data["P138"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_EPPICRole_spendLevelId = REQ_Data["P139"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_EPPICRegion_ProfitCenterId = REQ_Data["P140"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_EPPICResourcePool_matrixNumber = REQ_Data["P141"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_CompanyNumber_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_HRCostCenter_programId = REQ_Data["P13"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_CommodityCode_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_EPPICProject_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_EPPICRegion_ProfitCenterId = REQ_Data["P129"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_EPPICResourcePool_matrixNumber = REQ_Data["P111"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_WorkerClassification_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Requestor_altHiringManager = REQ_Data["P19"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_RequestOwner_hiringManager = REQ_Data["P18"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_Company_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_EngagementType_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T2_Select_GLAccount_GLIdJD = REQ_Data["P79"].ToString().Trim();
            createRequirementModelLabel.str_T2_Select_Business_organizationID = REQ_Data["P80"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_RateInformation_rdtypeoption = REQ_Data["P58"].ToString().Trim();
            createRequirementModelLabel.str_T2_Txt_NottoExceedBillRate_billRateHigh = REQ_Data["P62"].ToString().Trim(); 
            createRequirementModelLabel.str_T2_Txt_NottoExceedBillRate_billRateHigh = REQ_Data["P62"].ToString().Trim();

            createRequirementModelLabel.str_T1_btn_DoesthedesiredskillsetexistatRydertoday = REQ_Data["P160"].ToString().Trim();
            createRequirementModelLabel.str_T1_Text_Whoisthedesiredresource_singleLine9 = REQ_Data["P161"].ToString().Trim();
            createRequirementModelLabel.str_T1_Text_Whatisthereasonfortheinabilitytoattainthedesiredresource_singleLine10 = REQ_Data["P162"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_Isthisspendinyourplan = REQ_Data["P163"].ToString().Trim();
            createRequirementModelLabel.str_T1_Text_Ifthespendisintheplanwhatlocationcodeappliestoit_singleLine12 = REQ_Data["P164"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_Haveyousearchedfortheresourceininternalresourceapplication = REQ_Data["P165"].ToString().Trim();

            createRequirementModelLabel.str_T1_btn_IsDeveloper = REQ_Data["P166"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_NeedPCorMac = REQ_Data["P167"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_NeedsLaptoporDesktop = REQ_Data["P168"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_TravelandAncillaryExpenses_expenses = REQ_Data["P169"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_EstimatedExpenseAmountperResourceforContractPeriod_expenseFixedAmount = REQ_Data["P170"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_SalaryRangeMin_MinConversionSalary = REQ_Data["P171"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_SalaryRangeMax_MaxConversionSalary = REQ_Data["P172"].ToString().Trim();

            createRequirementModelLabel.str_Radiobtn_SkillMatrixMandatory_skillRequiredTrue = REQ_Data["P55"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_HRDepartment_deptNumber = REQ_Data["P90"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_LocationCode_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_AccountCode_CostCenterId = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_HypersionCodeGLUnit_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_BusinessUnit_organizationID = REQ_Data["P9"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_APDepartment_deptName = REQ_Data["P34"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_CORE_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_SkillMandatory_skillRequired = REQ_Data["P47"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_mandatoryPrestart = REQ_Data["P50"].ToString().Trim();
            createRequirementModelLabel.str_T2_btn_RecurringFrequencySubmit = REQ_Data["P53"].ToString().Trim();
            createRequirementModelLabel.str_T2_Txt_EstimatedLaborExpCost_estContractValue = REQ_Data["P63"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_RateNegotiable_rateNego = REQ_Data["P173"].ToString().Trim();
            createRequirementModelLabel.str_T2_Radiobutton_SubmitResumeswithHigherRates_rateCon = REQ_Data["P174"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_BusinessUnit_organizationID = REQ_Data["P30"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_ObjectAccount_GLId = REQ_Data["P14"].ToString().Trim();
            createRequirementModelLabel.str_T1_Select_Group_serviceMethodID = REQ_Data["P10"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_WorkWeek_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_ReasontoEngage_reasonToHireID = REQ_Data["P15"].ToString().Trim();
            createRequirementModelLabel.str_T1_select_DoestheCWhaveITorFacilitiesneeds_siteLocationID = REQ_Data["P31"].ToString().Trim();
            createRequirementModelLabel.str_T1_btn_WillCWAccessPII_laborClassCode = REQ_Data["P108"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_skillName_skillName = REQ_Data["P43"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Desired_skillDescDesired = REQ_Data["P44"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_Years_skillYearsExpID = REQ_Data["P46"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_EstHoursWeek_EstWeeklyHours = REQ_Data["P74"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_RateType_rateTypeID = REQ_Data["P77"].ToString().Trim();
            createRequirementModelLabel.str_T2_select_TypeofService_typeofServiceID = REQ_Data["P38"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Description_skillDescription = REQ_Data["P44"].ToString().Trim();
            createRequirementModelLabel.str_T2_txt_Mandatory_skillDescMandatory = REQ_Data["P41"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_WBSElement_ProjectId = REQ_Data["P109"].ToString().Trim();
            createRequirementModelLabel.str_T1_Typeahead_MatrixNumber_matrixNumber = REQ_Data["P111"].ToString().Trim();
            //Identified requiremetn repository added by manjusha
            createRequirementModelLabel.str_T4_Txt_LastName_lastname = REQ_Data["P200"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_FirstName_firstname = REQ_Data["P201"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_MiddleName_middlename = REQ_Data["P202"].ToString().Trim();
            createRequirementModelLabel.str_T4_Select_Suffix_nameSuffix = REQ_Data["P203"].ToString().Trim();
            createRequirementModelLabel.str_T4_btn_UploadResume_uploadResume = REQ_Data["P204"].ToString().Trim();
            createRequirementModelLabel.str_T4_Radiobutton_FormerEmployee_exEmployee = REQ_Data["P205"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_FormerEmployeeDetails_exEmployeeDetails = REQ_Data["P206"].ToString().Trim();
            createRequirementModelLabel.str_T4_Radiobutton_Retiree_retiredEmployee = REQ_Data["P207"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_RetireeDetails_retiredEmployeeDetails = REQ_Data["P208"].ToString().Trim();
            createRequirementModelLabel.str_T4_Radiobutton_FormerIntern_exIntern = REQ_Data["P209"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_FormerInternDetails_exInternDetails = REQ_Data["P210"].ToString().Trim();
            createRequirementModelLabel.str_T4_Radiobutton_FormerContractor_exContractor = REQ_Data["P211"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_FormerContractorDetails_exContractorDetails = REQ_Data["P212"].ToString().Trim();
            createRequirementModelLabel.str_T4_Txt_Justification_soleJustificationDescription = REQ_Data["P213"].ToString().Trim();
            createRequirementModelLabel.str_T4_btn_UploadJustification_uploadJustification = REQ_Data["P214"].ToString().Trim();
            createRequirementModelLabel.str_T4_Select_Supplier_supplierName = REQ_Data["P215"].ToString().Trim();


         //   createRequirementModelLabel.str_T2_Value_EstimatedcontrctValue = REQ_Data["P164"].ToString().Trim();
            return createRequirementModelLabel;
        }
