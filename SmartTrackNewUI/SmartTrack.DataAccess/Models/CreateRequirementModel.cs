...
namespace SmartTrack.DataAccess.Models
{
    ...
    public class CreateRequirementModel 
    {
        ...
        public string str_T1_Txt_DepartmentName_deptName { get; set; } //REQ_Data["P34"].ToString().Trim();
        public string str_T4_Txt_ContactLastName_recruiterLastName { get; set; } //REQ_Data["P216"].ToString().Trim();
        public string str_T4_Radiobutton_FormerUSGovtMilitaryEmployee_exGovMilEmployee { get; set; } //REQ_Data["P220"].ToString().Trim();
        public string str_T4_Txt_FormerUSGovtMilitaryEmployee_exGovMilEmployeeDetails { get; set; } //REQ_Data["P221"].ToString().Trim();
        public string str_T4_Txt_ContactFirstName_recruiterFirstName { get; set; } //REQ_Data["P217"].ToString().Trim();
        public string str_T4_Txt_Phone_workPhone { get; set; } //REQ_Data["P218"].ToString().Trim();
        public string str_T4_Txt_Email_workEmail { get; set; } //REQ_Data["P219"].ToString().Trim();

        // Models Added for Altria

        public string str_T4_lastdayWorked { get; set; }
        public string str_T4_lastSupervisor { get; set; }
        public string str_T4_lastcompany { get; set; }
        public string str_T4_lastRehireStatus { get; set; }
        public string str_T4_lastPosition { get; set; }
        public string str_T4_lastSeverenceStatus { get; set; }
        public string str_T4_lastReasonforLeaving { get; set; }
        public string str_T4_lastDeparment { get; set; }
        public string str_T4_lastServicesProvided { get; set; } 
        public string str_requirementnumber_Exist { get; set; } 
