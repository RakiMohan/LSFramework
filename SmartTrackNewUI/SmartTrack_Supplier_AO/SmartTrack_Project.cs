...
namespace SmartTrack_Automation
{
    ...
    public class SmartTrack
    {
        ...
        public void TestStart()
        {
            ...
            AcceptOffer objCreate_AcceptOffer = new AcceptOffer();
            ...
            // string strMainSql = "SELECT TestCaseId,NumberOfRepeats,DataSheet,Include,Url,Client,UserName FROM [" + strMainSheetName + "] where UserName = 'Supplier_AO'";
            string strMainSql = "SELECT TestCaseId,NumberOfRepeats,DataSheet,Include,Url,Client,UserName, Interview,Browser FROM [" + strMainSheetName + "] where UserName = 'Supplier_AO' and Run = 'Yes' and Include = 'Yes'";
                ...
                foreach (DataRow drowMain in MainSheetResult.dt.Rows)
                {
                    ...
                    if ((drowMain[3].ToString().ToUpper() == "YES") && (drowMain[0].ToString() != null) && (drowMain[2].ToString().Trim() != "") && (Convert.ToInt32(drowMain[1]) > 0))
                    {
                        ...
                        for (int iLoop = 1; iLoop <= Convert.ToInt32(drowMain[1]); iLoop++)
                        {
                           ...
                           // strUpdateSqlMain = "Update [Main$] set Run = 'P'  WHERE TestCaseId= '008' and Client ='" + drowMain[5].ToString() + "'";
                            ...
                            if (AllSheetResult.dt.Rows.Count > 0)
                            {
                                ...
                                for (int iSubRowLoop = 0; iSubRowLoop < AllSheetResult.dt.Rows.Count; iSubRowLoop++)
                                {
                                    ...
                                    if (AllSheetResult.dt.Rows[iSubRowLoop][0].ToString() != Constants.TestCase002)
                                    {
                                        ...
                                        string strUpdateSql = "Update [Supplier$] set TestExecute = 'P'  WHERE TestCaseId= '008' and P6 = '" + AllSheetResult.dt.Rows[iSubRowLoop]["P6"].ToString() + "' and P3 ='" + AllSheetResult.dt.Rows[iSubRowLoop]["P3"].ToString() + "'";
                                        ...
                                        case Constants.TestCase008:
                                            {
                                                ...
                                                if (strREQNumber != "")
                                                {
                                                    if (drowMain[7].ToString().ToLower()== "yes")
                                                    {
                                                        ...
                                                        // TestCaseResult = objCreate_AcceptOffer.RejectOffer_Method(driver, AllSheetResult.dt.Rows[iSubRowLoop]);
                                                        if (TestCaseResult.Result1 == KeyWords.Result_PASS)
                                                        {
                                                            ...
                                                            strUpdateSqlMain = "Update [MSP$] set TestExecute='No', TestExecute2='No', TestExecute3 = 'Yes'  WHERE TestCaseID= '007' and P3 ='" + AllSheetResult.dt.Rows[iSubRowLoop]["P3"].ToString() + "'";
                                                            ReadExcelHelper.UpdateDataToExcelFile(KeyWords.strExlInputPath, strUpdateSqlMain);

                                                           // Interview column mean Reject offer Method working. If Interview colum=yes reject offer method is working

                                                            strUpdateSqlMain = "Update [Main$] set Interview = 'No'  WHERE TestCaseId= '008' and Client ='" + AllSheetResult.dt.Rows[iSubRowLoop]["P3"].ToString() + "'";
                                                            ReadExcelHelper.UpdateDataToExcelFile(KeyWords.strExlInputPath, strUpdateSqlMain);
                                                            ...
                                                            //"\\SmartTrack_MSP_IWO.dll"
                                                            start.FileName = KeyWords.strNunitConsolePath;
                                                            Process.Start(start);
                                                            //System.Diagnostics.Process.Start(strExecutepath + "\\ExecuteScripts\\testrun_MSP_IWO.bat");
                                                        }
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        //TestCaseResult = objCreate_AcceptOffer.AcceptOffer_Method(driver, AllSheetResult.dt.Rows[iSubRowLoop], test);
                                                        if (TestCaseResult.Result1 == KeyWords.Result_PASS)
                                                        {
                                                            string[] strDataArray1 = new string[5];
                                                            string[] strColArray1 = new string[5];
