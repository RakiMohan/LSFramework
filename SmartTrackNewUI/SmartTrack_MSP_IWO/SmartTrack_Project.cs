...
namespace SmartTrack_Automation
{
    ...
    public class SmartTrack
    {
        ...
        public void TestStart()
        {
            ...
            //string strMainSql = "SELECT TestCaseId,NumberOfRepeats,DataSheet,Include,Url,Client,UserName FROM [" + strMainSheetName + "] where UserName = 'MSP_IWO'";
            string strMainSql = "SELECT TestCaseId,NumberOfRepeats,DataSheet,Include,Url,Client,UserName,Browser FROM [" + strMainSheetName + "] where UserName = 'MSP_IWO' and Run = 'Yes' and Include = 'Yes'";
            ...
            //string strMainSqlquery = "SELECT * FROM [" + strMainSheetName + "] where UserName = 'MSP_IWO' and TestCaseId ='009' and Client = 'WELCH ALLYN'";
